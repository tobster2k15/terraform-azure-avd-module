...
variable "vds_ramp_up"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_ramp_up_load_balancing"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_ramp_up_min_host_percentage"{
  type        = number
  description = ""
  default     = 0
}

variable "vds_ramp_up_capacity"{
  type        = number
  description = ""
  default     = 0
}

variable "vds_peak_start"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_peak_load_balancing"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_ramp_down_start"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_ramp_down_load_balancing"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_ramp_down_min_host_percentage"{
  type        = number
  description = ""
  default     = 0
}

variable "vds_ramp_down_force_logoff"{
  type        = bool
  description = ""
  default     = true
}

variable "vds_ramp_down_wait_time"{
  type        = number
  description = ""
  default     = 0
}

variable "vds_ramp_down_message"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_ramp_down_capacity"{
  type        = number
  description = ""
  default     = 0
}

variable "vds_ramp_down_stop_hosts_when"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_ramp_down_stops"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_off_peak_start"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_off_peak_load_balancing"{
  type        = string
  description = ""
  default     = ""
}

variable "vds_exclusion_tag"{
  type        = string
  description = ""
  default     = ""
}
